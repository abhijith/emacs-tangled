...
(add-to-list 'exec-path "/home/icylisper/.cask/bin")
#+END_SRC
* libraries
** package managment
#+BEGIN_SRC emacs-lisp :tangle yes
...
** no-littering
#+BEGIN_SRC emacs-lisp :tangle yes
(el-get-bundle tarsius/no-littering)
...
** epub
#+BEGIN_SRC emacs-lisp :tangle yes
(el-get-bundle wasamasa/nov.el)
(el-get-bundle Fuco1/justify-kp)
(use-package nov
  :init
...
(el-get-bundle markus1189/org-pdfview)
(el-get-bundle org-ebook
  :url "https://raw.githubusercontent.com/bddean/emacs-ereader/master/org-ebook.el")
...
(use-package find-file-in-project
  :init
  (bind-key "C-c c" (ffip-create-pattern-file-finder "*.clj")))
#+END_SRC
** git-modeline
** diff-hl
** magit
...
(el-get-bundle dgtized/github-clone.el)
#+END_SRC
...
** sql
#+BEGIN_SRC emacs-lisp :tangle yes
(el-get-bundle eric-hansen/helm-sql-connect)
#+END_SRC
* web
** eww
#+BEGIN_SRC emacs-lisp :tangle yes
